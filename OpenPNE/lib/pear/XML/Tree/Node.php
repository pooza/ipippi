...
// +----------------------------------------------------------------------+
// | Authors: Bernd R?er <berndr@bonn.edu>                               |
// |          Sebastian Bergmann <sb@sebastian-bergmann.de>               |
// |          Christian K?n <ck@chkuehn.de> (escape xml entities)        |
// +----------------------------------------------------------------------+
//
// $Id: Node.php,v 1.1 2005/11/10 04:46:06 ogawa Exp $
//

/**
* PEAR::XML_Tree_Node
*
* @author  Bernd R?er <berndr@bonn.edu>
* @package XML_Tree
