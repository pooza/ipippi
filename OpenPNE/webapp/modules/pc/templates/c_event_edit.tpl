...
<img src="img.php?filename=({$event.image_filename1})&h=120&w=120"><br>
<a href="do.php?cmd=c_event_edit_delete_c_commu_topic_comment_image&target_c_commu_topic_id=({$event.c_commu_topic_id})&pic_delete=1&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
<img src="img.php?filename=({$event.image_filename2})&h=120&w=120"><br>
<a href="do.php?cmd=c_event_edit_delete_c_commu_topic_comment_image&target_c_commu_topic_id=({$event.c_commu_topic_id})&pic_delete=2&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
({if $event.file_filename1})
({$event.file_filename1})
<a href="do.php?cmd=c_topic_edit_delete_c_commu_topic_comment_file&c_commu_topic_id=({$event.c_commu_topic_id})&file_index=1&sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
({if $event.file_filename2})
({$event.file_filename2})
<a href="do.php?cmd=c_topic_edit_delete_c_commu_topic_comment_file&c_commu_topic_id=({$event.c_commu_topic_id})&file_index=2&sessid=({$PHPSESSID})">削除</a><br>
({/if})
