...
<td style="width:562px;" class="bg_03" align="left" colspan="3">
...
<td style="width:140px;" class="bg_05" align="left">
...
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td style="width:411px;" class="bg_02">

<div class="padding_s">

({foreach from=$c_friend_list item=c_friend})
<div>
<input type="checkbox" name="c_member_id[]" value="({$c_friend.c_member_id})" class="no_bg">&nbsp;
<a href="page.php?p=f_home&amp;target_c_member_id=({$c_friend.c_member_id})">({$c_friend.nickname})</a>
</div>
({/foreach})
