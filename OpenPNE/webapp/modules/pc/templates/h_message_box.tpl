...
<img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_1"><a href="page.php?p=h_message_box&box=inbox">受信メッセージ</a>
({else})
...
({if $box != "outbox"})
<div align="left" style="padding:3px;" class="bg_02 border_10">
<img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_1"><a href="page.php?p=h_message_box&box=outbox">送信済みメッセージ</a>
({else})
<div align="left" style="padding:3px;" class="bg_09 border_10">
...
({if $box != "savebox"})
<div align="left" style="padding:3px;" class="bg_02 border_10">
<img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_1"><a href="page.php?p=h_message_box&box=savebox">下書きメッセージ</a>
({else})
<div align="left" style="padding:3px;" class="bg_09 border_10">
...
&nbsp;<img src="./skin/icon_mail_4.gif" class="icon">&nbsp;…&nbsp;返信済み
...
({if $ru_data.is_ru_prev})
 <a href="page.php?p=h_message_box&ru_page=({$ru_data.ru_page-1})&box=inbox">前を表示</a>
({/if})
...
({if $ru_data.is_ru_next})
 <a href="page.php?p=h_message_box&ru_page=({$ru_data.ru_page+1})&box=inbox">次を表示</a>
({/if})
...
({if $s_data.is_s_prev})
 <a href="page.php?p=h_message_box&s_page=({$s_data.s_page-1})&box=outbox">前を表示</a>
({/if})
...
件を表示
({if $s_data.is_s_next})
 <a href="page.php?p=h_message_box&s_page=({$s_data.s_page+1})&box=outbox">次を表示</a>
({/if})
</div>
...
({if $save_data.is_save_prev})
 <a href="page.php?p=h_message_box&save_page=({$save_data.save_page-1})&box=savebox">前を表示</a>
({/if})
...
({if $save_data.is_save_next})
 <a href="page.php?p=h_message_box&save_page=({$save_data.save_page+1})&box=savebox">次を表示</a>
({/if})
...
&nbsp;<img src="./skin/icon_mail_2.gif" class="icon">&nbsp;…&nbsp;受信&nbsp;
&nbsp;<img src="./skin/icon_mail_3.gif" class="icon">&nbsp;…&nbsp;送信済み&nbsp;
&nbsp;<img src="./skin/icon_mail_1.gif" class="icon">&nbsp;…&nbsp;下書き
...
({if $trash_data.is_trash_prev})
 <a href="page.php?p=h_message_box&trash_page=({$trash_data.trash_page-1})&box=trash">前を表示</a>
({/if})
...
<a href="page.php?p=h_message_box&trash_page=({$trash_data.trash_page+1})&box=trash">次を表示</a>
({/if})
