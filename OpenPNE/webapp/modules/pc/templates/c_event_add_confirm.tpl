...
<td style="width:368px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">以下の内容で作成します。よろしいですか？</span></td>
...
({$event.open_date_year})年({$event.open_date_month})月({$event.open_date_day})日
...
({$event.open_pref_value})&nbsp;({$event.open_pref_comment})
