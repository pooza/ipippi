...
<a href="page.php?p=f_home&target_c_member_id=({$member.c_member_id})">({if $member.image_filename})<img src="./img.php?filename=({$member.image_filename})&w=72&h=72">({else})<img src="./img.php?filename=no_image.gif&w=72&h=72">({/if})</a>
...
<tr>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td class="bg_01" align="center" colspan="7"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
<td align="right"><input type=submit name="yes_button" value="　送　信　">
</td>
</form>
