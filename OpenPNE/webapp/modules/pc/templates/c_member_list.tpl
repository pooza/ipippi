...
({if $is_prev})<a href="page.php?p=c_member_list&direc=-1&page=({$page})&target_c_commu_id=({$c_commu_id})">＜前</a>({/if})　
({$start_num})件～({$end_num})件を表示
({if $is_next})<a href="page.php?p=c_member_list&direc=1&page=({$page})&target_c_commu_id=({$c_commu_id})">次＞</a>({/if})
