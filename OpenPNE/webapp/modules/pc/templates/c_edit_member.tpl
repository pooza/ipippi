...
({if $is_prev})
<a href="page.php?p=c_edit_member&amp;target_c_commu_id=({$requests.target_c_commu_id})&amp;page=({$page})&amp;direc=-1">前を表示</a>&nbsp;&nbsp;
({/if})
({if $is_next})
&nbsp;&nbsp;<a href="page.php?p=c_edit_member&amp;target_c_commu_id=({$requests.target_c_commu_id})&amp;page=({$page})&amp;direc=1">次を表示</a>
({/if})
...
<a href="page.php?p=f_home&amp;target_c_member_id=({$c_member.c_member_id})">({$c_member.nickname})</a>

</td>
<td class="bg_02">

({if !$c_member.is_c_commu_admin})
<a href="./do.php?cmd=c_edit_member_delete_c_commu_member&amp;target_c_commu_id=({$c_commu.c_commu_id})&target_c_member_id=({$c_member.c_member_id})&amp;sessid=({$PHPSESSID})">コミュニティから退会させる</a>
({else})
&nbsp;
({/if})
...
<a href="./page.php?p=c_admin_request&amp;target_c_commu_id=({$c_commu.c_commu_id})&target_c_member_id=({$c_member.c_member_id})">管理権を渡す</a>
({else})
&nbsp;
({/if})
