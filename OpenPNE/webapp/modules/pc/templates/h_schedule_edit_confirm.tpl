...
<tr>
<td class="bg_06"><img src="./skin/content_header_1.gif" style="width: 30px;height: 20px;" class="dummy" align="left"><div class="b_b c_00" style="padding:3px 0px;">以下の内容でよろしいですか？</div></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
<input type="hidden" name="cmd" value="h_schedule_edit_update_c_schedule">
...
<td><input type="submit" value="　 編　　集 　">
</form>
...
<input type="hidden" name="end_minute" value="({$input.end_minute})">
<input type="hidden" name="is_receive_mail" value="({$input.is_receive_mail})">
<td><input type="submit" value="　 修　　正 　"><br>
</form>
