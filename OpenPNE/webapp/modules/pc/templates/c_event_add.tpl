...
<td style="width:598px;" class="bg_06"><span class="b_b c_00">[({$c_commu.name})]&nbsp;新しいイベントを作成する</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
<input type="text" name="title" value="({$event.title})" size="40" maxlength="126">
...
（補足：<input name="open_date_comment" value="({$event.open_date_comment})" style="width:15em;">）
...
(補足：<input type="text" name="open_pref_comment" value="({$event.open_pref_comment})" style="width:15em;">)
...
<textarea name="detail" style="width:30em;height:6em;">({$event.detail})</textarea>
...
<input type="file" name="image_filename1" name="photo1" size="40">
...
<input type="file" name="image_filename2" name="photo2" size="40">
...
<input type="file" name="file_filename1" name="photo2" size="40">
...
<input type="file" name="file_filename2" name="photo2" size="40">
