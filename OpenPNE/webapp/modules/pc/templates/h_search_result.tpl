...
&nbsp;&nbsp;
({if $pager.page_prev})
<a href="page.php?p=h_search_result&amp;page=({$pager.page_prev})&amp;({$search_condition})">前を表示</a>
({/if})
...
({if $pager.page_next})
<a href="page.php?p=h_search_result&amp;page=({$pager.page_next})&amp;({$search_condition})">次を表示</a>
({/if})
</div>
</td>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
...
<div class="padding_s">
<a href="page.php?p=f_home&target_c_member_id=({$item.c_member_id})"><img src="./skin/btn/shousai.gif" alt="詳細を見る"></a>
</div>
