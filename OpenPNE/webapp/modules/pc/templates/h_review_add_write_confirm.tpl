...
({if $satisfaction_level eq 1})<img src="skin/satisfaction_level_1.gif" class="icon">({/if})
({if $satisfaction_level eq 2})<img src="skin/satisfaction_level_2.gif" class="icon">({/if})
({if $satisfaction_level eq 3})<img src="skin/satisfaction_level_3.gif" class="icon">({/if})
({if $satisfaction_level eq 4})<img src="skin/satisfaction_level_4.gif" class="icon">({/if})
({if $satisfaction_level eq 5})<img src="skin/satisfaction_level_5.gif" class="icon">({/if})
