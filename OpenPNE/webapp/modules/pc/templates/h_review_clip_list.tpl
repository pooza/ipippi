...
({*********})
<tr>
<td style="width:540px;height:1px;" class="bg_01" colspan="3"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
<span>おすすめしたい書籍、CD、DVD、劇場映画などを登録することができます。</span>
...
<a href="page.php?p=h_review_search">全体のレビュー一覧を見る</a>
...
<img src="./skin/dummy.gif" class="icon arrow_1">
<a href="page.php?p=h_review_clip_list">クリップを見る</a>
...
({if $is_prev})<a href=page.php?p=h_review_clip_list&direc=-1&page=({$page})>＜前</a> ({/if})
({$start_num})件～({$end_num})件を表示
({if $is_next})<a href=page.php?p=h_review_clip_list&direc=1&page=({$page})>次＞</a>({/if})
...
<tr>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
<td style="width:369px;" class="bg_01" align="center" colspan="5"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
</tr>
({*********})
<tr>
...
<a href="page.php?p=h_review_list_product&c_review_id=({$review.c_review_id})">全てのレビューを見る (({$review.write_num|default:"0"}))</a>
