...
<td style="width:561px;" class="bg_00"><img src="./skin/dummy.gif" style="width:561px;height:7px;" class="dummy"></td>
<td style="width:7px;" class="bg_00"><img src="./skin/dummy.gif" style="width:7px;height:7px;" class="dummy"></td>
</tr>
<tr>
...
({if $item!=$page})<a href="page.php?p=c_event_member_list&page=({$item})&target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">({$item})</a>
({else})({$item})
({/if})
({/foreach})]
...
({if $is_prev})<a href="page.php?p=c_event_member_list&direc=-1&page=({$page})&target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">＜前</a>({/if})　
({$start_num})件～({$end_num})件を表示
({if $is_next})<a href="page.php?p=c_event_member_list&direc=1&page=({$page})&target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">次＞</a>({/if})
...
[ ({foreach from=$page_num item=item})
({if $item!=$page})
<a href="page.php?p=c_event_member_list&page=({$item})&target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">({$item})</a>
({else})
({$item})
({/if})
({/foreach})]
...
<!-- ************************************ -->
<!-- ******ここから：イベントトップへ****** -->
<div id="link_event_top" align="center">

<img src="./skin/dummy.gif" class="icon arrow_1">&nbsp;
<a href="page.php?p=c_event_detail&target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">イベント [({$c_topic.name})] トップへ</a>
