...
<td style="width:598px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">({$WORD_MY_FRIEND})最新レビュー</span></td>
</tr>
</table>
</div>
<!-- ここまで：小タイトル -->
...
({if $is_prev})
<a href="page.php?p=h_friend_review_list&amp;page=({$page})&amp;direc=-1">前を表示</a>&nbsp;&nbsp;
({/if})({$start_num})件～({$total_num})件を表示({if $is_next})
&nbsp;&nbsp;<a href="page.php?p=h_friend_review_list&amp;page=({$page})&amp;direc=1">次を表示</a>
({/if})
...
<a href="page.php?p=h_review_list_product&c_review_id=({$item.c_review_id})">({$item.title|t_truncate:50})</a>
(({$item.nickname}))
