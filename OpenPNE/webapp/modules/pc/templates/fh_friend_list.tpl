...
({if $is_prev})&nbsp;<a href="page.php?p=fh_friend_list&amp;target_c_member_id=({$target_member.c_member_id})&amp;direc=-1&amp;page=({$page})">前を表示</a>&nbsp;({/if})
({$start_num})件〜({$end_num})件を表示&nbsp;
({if $is_next})&nbsp;<a href="page.php?p=fh_friend_list&amp;target_c_member_id=({$target_member.c_member_id})&amp;direc=1&amp;page=({$page})">次を表示</a>&nbsp;({/if})
&nbsp;
