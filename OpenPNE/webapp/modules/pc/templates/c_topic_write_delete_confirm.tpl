...
({if $c_commu_topic_comment.image_filename1})<img src="img.php?filename=({$c_commu_topic_comment.image_filename1})&h=120&w=120">({/if})
({if $c_commu_topic_comment.image_filename2})<img src="img.php?filename=({$c_commu_topic_comment.image_filename2})&h=120&w=120">({/if})
({if $c_commu_topic_comment.image_filename3})<img src="img.php?filename=({$c_commu_topic_comment.image_filename3})&h=120&w=120">({/if})
<br>
