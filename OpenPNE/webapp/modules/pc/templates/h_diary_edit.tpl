...
<tr>
<td style="width:36px;" class="bg_06"><img src="./skin/content_header_1.gif" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:488px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">日記を編集する</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
({*削除ボタン1*})
<a href="do.php?cmd=h_diary_edit_delete_image&target_c_diary_id=({$diary.c_diary_id})&del_img=1&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
({*削除ボタン2*})
<a href="do.php?cmd=h_diary_edit_delete_image&target_c_diary_id=({$diary.c_diary_id})&del_img=2&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
({*削除ボタン3*})
<a href="do.php?cmd=h_diary_edit_delete_image&target_c_diary_id=({$diary.c_diary_id})&del_img=3&amp;sessid=({$PHPSESSID})">削除</a><br>
({/if})
...
<input type="radio" name="image_position" value="TOP" class="no_bg" ({if $image_position=="TOP"})checked({/if})> 本文の上
<input type="radio" name="image_position" value="BOTTOM" class="no_bg"  ({if $image_position=="BOTTOM"})checked({/if})> 本文の下
...
<tr>
<td style="width:36px;" class="bg_06"><img src="./skin/content_header_1.gif" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:488px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">日記を削除する</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
