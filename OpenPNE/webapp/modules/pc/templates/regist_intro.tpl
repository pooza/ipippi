...
<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">会員登録</span></td>
</tr>
</table>
</div>
<!-- ここまで：小タイトル -->
...
<td style="width:498px;" class="bg_02" align="left" valign="middle">

<div style="padding:10px 30px;">

サービスを利用するには、以下の規約を遵守してください。<br>
...
<tr>
<td style="width:36px;" class="bg_06"><img src="./skin/content_header_1.gif" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:528px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">利用規約</span></td>
</tr>
</table>
</div>
<!-- ここまで：小タイトル -->
...
<input type="submit" class="submit" value="同意して登録手続きへ">
</form>
