...
({if $pager.prev_page})
<a href="page.php?p=fh_com_list&amp;page=({$pager.prev_page})&amp;target_c_member_id=({$target_member.c_member_id})">前を表示</a>&nbsp;
({/if})
({$pager.start_num})件～({$pager.end_num})件を表示
({if $pager.next_page})
&nbsp;<a href="page.php?p=fh_com_list&amp;page=({$pager.next_page})&amp;target_c_member_id=({$target_member.c_member_id})">次を表示</a>
({/if})
&nbsp;
</td>
<td style="width:1px;" class="bg_01" align="center"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
