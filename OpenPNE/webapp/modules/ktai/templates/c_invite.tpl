...
<br>
ﾒｯｾｰｼﾞ<br>
<textarea name="body">({$c_commu.name})のコミュニティに入ってみました。よかったら一緒にどうですか？</textarea><br>
<input type="submit" value="送信">
</form>
送信先の選択肢はランダムとなっています。送りたいﾒﾝﾊﾞｰがﾘｽﾄに表示されなかった場合、
<a href="ktai_page.php?p=c_invite&amp;target_c_commu_id=({$target_c_commu_id})&amp;({$tail})">ここ</a>を押して画面を更新してください
<hr>
